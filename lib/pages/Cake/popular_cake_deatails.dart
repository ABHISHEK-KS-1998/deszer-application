...
import 'package:deszer_application1/models/cart_model.dart';
import 'package:deszer_application1/models/product_model.dart';
...
class PopularCakeDetail extends StatelessWidget {
  final int pageId;
  final String page;
   const PopularCakeDetail({required this.pageId, super.key, required this.page});
        ...
        children: [
          ...
          Positioned(
              ...
              child: Container(
                ...
                height: Dimensions.popularCakeImgSize,
          ...
          Positioned(
              left: 0,
              right: 0,
              top: Dimensions.popularCakeImgSize - 20,
              bottom: 0,
              child: Container(
